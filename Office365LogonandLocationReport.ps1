...
#>
 ...
 function Get-Office365LogonAndLocationReport
 {
    ...
    foreach ($userId in $userIds) {
        ...
        foreach ($ip in $ips) {
            ...
            $mergedObject | Select-Object UserId, Operation, CreationTime, @{Name = "UserAgent"; Expression = {$UserAgent}}, Query, ISP, City, RegionName, Country  | export-csv $home\desktop\Office365_UserLocationData.csv -Append -NoTypeInformation
        }
    }
}
